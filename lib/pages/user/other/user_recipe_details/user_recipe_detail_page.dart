...
class UserRecipesDetailPage extends StatefulWidget {
  final String? recipeId;
  const UserRecipesDetailPage({super.key, this.recipeId});

  @override
  State<UserRecipesDetailPage> createState() => _UserRecipesDetailPageState();
}

class _UserRecipesDetailPageState extends State<UserRecipesDetailPage> {
